...
export default function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto w-full">
      {/* Brand */}
      <div className="flex items-center gap-1.5 font-bold text-xl tracking-tight cursor-pointer" onClick={() => navigate('/')}>
      ...
      <ul className="hidden md:flex items-center gap-8 text-sm font-medium">
        <li><a href="#" className="text-white hover:text-indigo-300 transition-colors" onClick={() => navigate('/dashboard')}>Dashboard</a></li>
